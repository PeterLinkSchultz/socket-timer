...
var _socket2 = __webpack_require__(/*! socket.io-client */ "./node_modules/socket.io-client/lib/index.js");
...
function Tree(_addLog) {
    var tree = void 0,
        data = {},
        rooms = (0, _jquery2.default)("#rooms"),
        objects = (0, _jquery2.default)("#objects"),
        secrets = (0, _jquery2.default)("#secrets"),
        currentRoom = void 0,
        _socket = void 0,
        addLog = _addLog,
        _timer = void 0,
        currentObject = void 0,
        currentSecret = void 0,
        current = void 0;
    ...
    function renderRooms() {
        ...
        secrets.html("");
        rooms.html("");
        tree.forEach(function (item, key) {
    ...
    function renderObject() {
        objects.html("");
        secrets.html("");
        currentRoom.tree.forEach(function (item, key) {
    ...
    function renderSecret() {
        ...
        currentObject.tree.forEach(function (item, key) {
...
function Room(data, parent, callback, key) {
    var _data = data,
        _parent = parent,
        room = (0, _jquery2.default)('<li>' + _data.name + '</li>').click(function () {
        callback(key);
    });
...
function Confirm(callback, info) {
    var confirm = (0, _jquery2.default)("#confirm"),
        _callback = callback,
        success = (0, _jquery2.default)("<a>Yes</a>"),
        cancel = (0, _jquery2.default)("<a>No</a>");
...
function Logger(_root) {
    var root = _root,
        logs = [],
        table = (0, _jquery2.default)('<table class="logger">'),
        thead = (0, _jquery2.default)('<thead>'),
        tbody = (0, _jquery2.default)('<tbody>');
...
function Lang(_root, _lang, _callback, _default) {
    var root = _root,
        cont = (0, _jquery2.default)('<div class="lang-cont">'),
        lang = _lang,
        current = _default,
        buttons = [],
        callback = _callback;
    ...
    function render() {
        ...
        lang.forEach(function (item) {
            var button = (0, _jquery2.default)('<div class="lang">' + item + '</div>').click(function (e) {
                if (current !== item) {
                    current = item;
                    callback(item);
                    render();
            ...
            if (current === item) button.addClass('active');
            cont.append(button);
        });
    }
...
function Field() {
    ...
    var start = 59;
    var currentMinutes = 59,
        currentSeconds = 59,
        isDirtyM = false,
        isDirtyS = false;

    var mask = /[0-5]{1}[0-9]{1}/;

    var minutes = (0, _jquery2.default)('<input class="field" id="minutes" maxlength="2" value="' + start + '"/>');
    var delimiter = (0, _jquery2.default)('<span class="delimiter">:</span>');
    var seconds = (0, _jquery2.default)('<input class="field" id="seconds" maxlength="2" value="' + start + '"/>');

    minutes.keypress(function (event) {
        isDirtyM = true;
    });
    ...
    seconds.keypress(function (event) {
        isDirtyS = true;
    });
    ...
    (0, _jquery2.default)('#field').append(minutes).append(delimiter).append(seconds);
...
(0, _jquery2.default)(document).ready(function () {
    var socket = (0, _socket3.default)(window.location.origin, {
        ...
        lang = new Lang((0, _jquery2.default)('#lang'), ['sp', 'en'], tree.setData, 'sp');
    ...
    socket.on('timer:setTime', function (data) {
        var time = data.time,
